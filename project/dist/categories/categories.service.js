...
let CategoriesService = class CategoriesService {
    categoriesRespoitory;
    constructor(categoriesRespoitory) {
        this.categoriesRespoitory = categoriesRespoitory;
    }
    async Seeder() {
        const categoryName = new Set(data_json_1.default.map((Product) => Product.category));
        const categoriesArray = Array.from(categoryName);
